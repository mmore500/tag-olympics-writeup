...
\caption{
Trajectories of adaptive evolution for each tag-matching metric on the 64-vertex graph-matching task.
...
(See Supplementary Figure \ref{fig:evolve_big_mutsweep} for survey of how mutation rate affects adaptive evolution under each metric.)
