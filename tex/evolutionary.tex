...
Sections \label{sec:geometric} and \label{sec:variational} reported how each tag-matching metric induced constraints on tag-match affinities and the distribution of mutational outcomes.
