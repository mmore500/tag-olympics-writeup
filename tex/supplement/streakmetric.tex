...
For computational efficiency and consistency with the existing literature we simply clamp edge cases between 0 and 1 to yield the corrected streak metric $S$.
