...
These computational operands include
\begin{itemize}
  ...
  \item individual neurons or neural modules in neuroevolution \citep{reisinger2007acquiring}, and
...
\begin{itemize}
    \item Hamming distance between bitstrings (e.g., \cite{lalejini2018evolving,banzhaf2003artificial}) or
    \item differences between real-valued scalars (e.g., \cite{riolo2001evolution,spector2011tag}).
\end{itemize}
...
More exotic tag-matching extensions have explored, too, such as incorporation of a wildcard ``match-any'' character into tag alphabets \citep{holland2012signals} or automatic generation of operand tags based on the underlying functional behavior of each particular tagged component \citep{lones2004modelling}.
...
Evolutionary experiments also showed significant differences between tag-matching schemes.
