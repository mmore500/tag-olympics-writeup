...
Note that match distance normalization has no effect in experiments where tag-matching is performed exclusively by relative ordering (i.e., evolutionary experiments with the graph-matching and changing-signal tasks introduced later on).
