...
Under this distribution, value changes of each binary order of magnitude are equally likely (corresponding to the ).
Occasional large-effect mutations provides a reasonable explanation for the bidirectional integer metric's rapid increase in match distance under mutation relative to the hamming and streak metrics.
