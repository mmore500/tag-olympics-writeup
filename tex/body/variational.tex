...
Additionally, in a supplementary experiment we found that the bitwise mutational operator outperforms a normally-distributed mutation operator on the 32-vertex graph-matching task discussed in \ref{sec:graph-matching}.
